# Chat/NewChat/WebApp/pages/register_page.py
...
it has been created in THAT session. This small page object lets the New Chat
flow register the account first (same browser session) before signing in.
Locators come from the register screen's DOM (stable element IDs).
"""
