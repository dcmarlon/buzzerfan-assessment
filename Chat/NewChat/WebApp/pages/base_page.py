# Chat/NewChat/WebApp/pages/base_page.py
"""Base page object.
...
class BasePage:
    ...
    def wait_present(self, locator: Locator, timeout: int | None = None) -> bool:
        ...
        may not yet be painted. Used to detect whether a screen rendered.
    ...
    def wait_invisible(self, locator: Locator, timeout: int | None = None) -> bool:
        ...
        Useful for confirming that a page has been left behind — e.g. the new
        chat form disappearing once the chat is created.
