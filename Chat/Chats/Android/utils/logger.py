# Chat/Chats/Android/utils/logger.py
"""Centralized logging for the Android Chats test.
...
The list of chats required by the acceptance criteria is printed THROUGH this
logger, so it appears on screen and in the log file at once.
"""
...
def get_logger(name: str = "android_chats") -> logging.Logger:
