# Chat/Chats/Android/pages/login_page.py
"""Login page object for the Furgechat Android app (reused for the Chats flow).

The Chats test must sign in as admin before the dashboard is reachable. This is
the same login screen as Auth/Login/Android: a Flutter app driven via
