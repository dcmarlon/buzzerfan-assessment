# Chat/Chats/WebApp/utils/config.py
"""Configuration loader.

Reads connection details and the optional login block from ``credentials.json``
so that no URL or secret is ever hardcoded in the test logic. Keeping this in one
