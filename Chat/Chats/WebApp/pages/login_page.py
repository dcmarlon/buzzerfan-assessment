# Chat/Chats/WebApp/pages/login_page.py
"""Login page object — used ONLY when the chats screen requires a session.

This is an optional helper for this read-only feature: if the app redirects
"/chats" to the login page, set ``login.enabled = true`` in credentials.json and
the test will authenticate here first. It mirrors the standalone Auth/Login page
object, including the captcha gate on the submit button.
...
class LoginPage(BasePage):
    """Page object for the login form (optional pre-step for this feature)."""
