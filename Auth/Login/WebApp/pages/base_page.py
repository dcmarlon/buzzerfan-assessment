# Auth/Login/WebApp/pages/base_page.py
"""Base page object.
...
class BasePage:
    ...
    def is_visible(self, locator: Locator, timeout: int | None = None) -> bool:
        ...
        Used for assertions (e.g. confirming a post-login element appears)
    ...
    def wait_invisible(self, locator: Locator, timeout: int | None = None) -> bool:
        ...
        login form disappearing once authentication succeeds.
