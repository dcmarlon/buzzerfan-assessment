# Auth/Login/WebApp/utils/config.py
"""Configuration loader.

Reads connection details and credentials from ``credentials.json`` so that no
URL or secret is ever hardcoded in the test logic. Keeping this in one place
means the test can be re-pointed at a different environment by editing a single
file.
"""
